...
; Generated by XYZ on 2/11/2015 (UTC)
;
[Setup]
AppID={{687e7e37-52cd-422e-b66d-c252fce34a7f}
AppName=ASCOM Acme Focuser Driver
AppVerName=ASCOM Acme Focuser Driver 1.2
AppVersion=1.2
AppPublisher=XYZ <xyz@xyz.com>
AppPublisherURL=mailto:xyz@xyz.com
AppSupportURL=http://groups.yahoo.com/group/ASCOM-Talk/
...
OutputDir="."
OutputBaseFilename="Acme Focuser Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\Acme"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\Acme"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Acme.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Acme.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Acme.Focuser.dll"""; Flags: runhidden 32bit

; The following line ensures the 64-bit registry entries will be completely removed when unregistered!
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Acme.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Acme.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
