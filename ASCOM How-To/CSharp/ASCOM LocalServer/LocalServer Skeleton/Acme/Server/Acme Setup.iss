...
;
[Setup]
AppID={{557617f6-5b44-4a83-a418-7f81ff0652e9}
AppName=ASCOM Acme Focuser & FilterWheel Drivers Server
AppVerName=ASCOM Acme FocuserFilterWheel Driver 1.2
AppVersion=1.2
...
DefaultDirName="{cf}\ASCOM\Acme\FocuserFilterWheel"
DisableDirPage=yes
DisableProgramGroupPage=yes
OutputDir="."
OutputBaseFilename="Acme FocuserFilterWheel Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Acme\FocuserFilterWheel"
...
Filename: "{app}\ASCOM.Acme.Server.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.Acme.Server.exe"; Parameters: "/unregister"
